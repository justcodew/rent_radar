...
from app.services.crawler.core.tools.browser_launcher import BrowserLauncher
...
class CDPBrowserManager:
    ...
    async def add_stealth_script(self, script_path: str = "app/services/crawler/libs/stealth.min.js"):
        """
