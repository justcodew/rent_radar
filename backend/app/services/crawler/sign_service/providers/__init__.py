...
from app.services.crawler.sign_service.providers.base import ProviderRegistry, SignProvider, registry

# 导入各 provider 模块,触发 registry.register()
from app.services.crawler.sign_service.providers import (  # noqa: F401,E402
